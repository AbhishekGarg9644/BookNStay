...
//     console.log("Connected to local MongoDB (wanderLust database)");
// }
async function main() {
...
// async function main() {
//     await mongoose.connect('mongosh "mongodb+srv://cluster0.foioik4.mongodb.net/" --apiVersion 1 --username shivagargabhi');  
// }
